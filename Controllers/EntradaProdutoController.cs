...
namespace ProjetoFinal.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,DataEntrada,QtdEntrada")] EntradaProduto entradaProduto)
        {
            if (ModelState.IsValid)
            {
                var produto = await _context.Produto.Where(p => p.Id == entradaProduto.ProdutoId).FirstOrDefaultAsync();
                produto.QtdEstoque = produto.QtdEstoque + entradaProduto.QtdEntrada;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,DataEntrada,QtdEntrada")] EntradaProduto entradaProduto)
        {
