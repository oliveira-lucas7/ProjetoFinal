...
namespace ProjetoFinal.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeProduto,QtdEstoque,TipoProdutoId,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeProduto,QtdEstoque,TipoProdutoId,FornecedorId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
